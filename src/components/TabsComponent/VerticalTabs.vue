        ...
        <div class="lg:w-3/4">
          ...
          >
            <div class="grid md:grid-cols-2 gap-0">
              ...
              <div class="p-8">
                <h2
                  :class="['text-2xl font-bold mb-4', 'text-tabs-title-text']"
                >
                ...
                <div class="space-y-4 mb-8">
                  <div
                    v-for="(feature, idx) in items[activeIndex].features"
                    :key="idx"
              ...
              <!-- Right Column: Image -->
              <div
                class="h-full min-h-[300px] bg-gray-100 flex items-center justify-center"
              >
                <img
                  :src="items[activeIndex].image.url || '/placeholder.svg'"
