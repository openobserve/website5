      ...
      >
        <div id="blog-content" class="">
          ...
          <template>
            <div
              v-html="htmlContent"
              class="prose prose-md prose-invert prose-pre:bg-gray-800 prose-pre:max-h-96 max-w-none break-words prose-table:w-full prose-th:px-4 prose-th:py-2 prose-td:px-4 prose-td:py-2 text-black [--tw-prose-headings:theme(colors.black)] [--tw-prose-bold:theme(colors.black)] [--tw-prose-body:theme(colors.black)]"
            ></div>
          </template>
        </div>
        <div class="py-3">
