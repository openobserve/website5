...
<template>
  <dynamicComponent :href="card.link"
    class="rounded-2xl w-full p-[0.0625rem] bg-gradient-gray hover:bg-gradient-blue transition-all duration-300 shadow-2xl hover:shadow-[0_0_60px_0_rgba(66,174,255,0.8)] mx-auto group">
    <!-- Content Layer -->
    <div
      ...
      <h3 class="text-[#BEC0C2] text-xs md:text-base font-semibold text-center group-hover:text-[#80B9FF] title-fixed"
        :title="card.title">
        {{ card.title }}
      </h3>
    </div>
