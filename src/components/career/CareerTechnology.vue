      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          ...
          >
            ...
            <div>
              <h3 v-if="feature?.title" class="text-xl font-bold">{{ feature.title }}</h3>
        ...
        <div class="bg-gray-100 p-6 rounded-lg">
          <h3 v-if="techTags?.title" class="text-xl font-bold mb-4">{{ techTags.title }}</h3>
          ...
          <div v-if="techFeatures?.length" class="mt-6">
            <template v-for="featureGroup in techFeatures" :key="featureGroup?.id">
              <h4 v-if="featureGroup?.title" class="font-bold mb-2">{{ featureGroup.title }}</h4>
              <ul v-if="featureGroup?.items?.length" class="list-disc list-inside space-y-2 text-gray-500">
