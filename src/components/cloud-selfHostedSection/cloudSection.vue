    ...
    <div class="justify-center grid grid-cols-1 lg:grid-cols-2 gap-5">
      ...
      >
        ...
        <!-- <div class="space-y-4 mb-8 flex flex-col items-center justify-center">
          ...
          <a href="https://auth.openobserve.ai/dex/auth/gitlab?client_id=o2-client&redirect_uri=https%3A%2F%2Fcloud.openobserve.ai%2Fconfig%2Fredirect&response_type=code&scope=openid+profile+email+groups+offline_access&state=5cuFXm2a0iMLlHZvJNCJVK9NgTPUNWLp" target="_blank" class="w-full md:w-80">
            <button
          ...
          <a href="https://auth.openobserve.ai/dex/auth/google?client_id=o2-client&redirect_uri=https%3A%2F%2Fcloud.openobserve.ai%2Fconfig%2Fredirect&response_type=code&scope=openid+profile+email+groups+offline_access&state=5cuFXm2a0iMLlHZvJNCJVK9NgTPUNWLp" target="_blank" class="w-full md:w-80">
            <button
              class="flex items-center justify-start gap-5 md:gap-10  w-full bg-gray-800 text-gray-200 rounded-lg p-2 md:p-3 shadow-md hover:bg-gray-700 transition"
            >
          ...
          <a href="https://auth.openobserve.ai/dex/auth/microsoft?client_id=o2-client&redirect_uri=https%3A%2F%2Fcloud.openobserve.ai%2Fconfig%2Fredirect&response_type=code&scope=openid+profile+email+groups+offline_access&state=5cuFXm2a0iMLlHZvJNCJVK9NgTPUNWLp" target="_blank" class="w-full md:w-80">
            <button
              class="flex items-center justify-start gap-5 md:gap-10 w-full bg-gray-800 text-gray-200 rounded-lg p-2 md:p-3 shadow-md hover:bg-gray-700 transition"
            >
              <img
