    ...
    <div class="w-full mx-auto">
      ...
      <div class="flex relative border-b-[3px] border-gray-500">
        <button
          ...
          :class="selectedTab === 'cloud'
              ? 'text-white'
              : 'border-transparent cld-be-effect'
            " @click="selectedTab = 'cloud'">
          Cloud
        </button>
        <button class="w-1/2 slf-btn py-2 text-md md:text-lg font-semibold transition-colors duration-300 relative"
          :class="selectedTab === 'selfHosted'
              ? 'text-white'
