...
<template>
  <component :is="buttonLink ? 'a' : 'button'" :class="[containerClass, buttonSize, buttonVariant]" @click="onClick"
    :disabled="disabled || loading" :href="buttonLink" :target="target" :type="!buttonLink ? type : null"
    v-bind="buttonProps">
