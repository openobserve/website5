...
<template>
  <div class="w-full flex flex-col gap-4 relative pt-6 lg:pt-4">
    ...
    <div
      class="w-full flex flex-col lg:flex-row justify-center items-center gap-4 md:gap-6"
      :class="sectionClasses"
    >
      <!-- Quote Section -->
      <div
        class="relative h-auto rounded-lg border border-gray-200 bg-white shadow-sm p-3 z-10 w-full lg:w-1/2"
      >
          ...
          >
            <div class="space-y-1">
              <div class="flex items-center">
                <Check
                  class="h-5 w-5 mr-2 bg-blue-500/20 rounded-full p-1 text-blue-500"
                />
                <h2
