...
// Define webinar details for popup
...
<template>
  ...
  >
    <div class="relative">
      <div
        class="h-48 flex items-center justify-center relative bg-cover bg-center"
        :style="
          webinar.image?.url
            ? `background-image: url(${webinar.image.url})`
            : ''
        "
      >
    ...
    <div class="p-4 flex flex-col flex-1">
      ...
      <p class="text-gray-600 text-sm mb-4 line-clamp-2">
        {{ webinar.overview || webinar.description }}
      </p>
