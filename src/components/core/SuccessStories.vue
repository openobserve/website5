<template>
  <section class="w-full" :class="background ? 'bg-gray-50' : ''">
    <CustomSection>
      <HeadingSection :title="sectionTitle" :description="sectionDescription" />
      <div
        class="mx-auto grid gap-8 pb-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"
      >
        <!-- Success Story Cards -->
        <div
        ...
        >
          <div class="flex flex-col flex-grow">
            ...
            <ul class="mb-4 space-y-2 mt-auto">
              ...
              >
                <CheckCircle
                  class="h-5 w-5 text-primary-green mt-0.5 flex-shrink-0"
                />
