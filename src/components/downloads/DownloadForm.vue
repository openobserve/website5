  ...
  <CustomSection sectionClass="!pt-10">
    <div class="contact-form-card">
      ...
      <div class="w-full mb-16 text-center">
        <h3 class="text-3xl md:text-4xl font-bold text-black">{{ title }}</h3>
      </div>
        ...
        <template v-else>
          <form @submit.prevent="handleSubmit" class="contact-form">
            <div class="contact-form-fields space-y-4">
              ...
              <div>
                <label for="interest" class="contact-form-label"
                  >Interest</label
                >
                <select
                  id="interest"
...
defineProps({
  ...
  description: {
    ...
    required: false,
    default:
      "Have questions about deployment options? Our team is here to help.",
  },
});
// const formData = ref({
//   fname: "",
