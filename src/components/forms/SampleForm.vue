    ...
    <form @submit.prevent="onSubmit">
      <div class="space-y-3">
        ...
        <div>
          ...
          <CustomInput id="jobTitle" v-model="jobTitle.value.value" name="jobTitle" placeholder="Enter here" />
          <span v-if="jobTitle.errorMessage.value" class="text-xs text-red-500">{{ jobTitle.errorMessage.value }}</span>
        </div>

        <div>
          <label for="deployment" class="text-gray-200 font-medium cursor-pointer">
            Deployment Interest <span class="text-red-500">*</span>
          </label>
          <select id="deployment" v-model="deployment.value.value" name="deployment"
        ...
        <div>
          <label for="dataVolume" class="text-gray-200 font-medium cursor-pointer">
      ...
      <div class="flex items-start gap-2">
        ...
        <div>
          <label for="terms" class="text-white text-sm cursor-pointer select-none">
            ...
            <a href="/policies/terms-of-service" class="text-blue-500 underline" target="_blank">
              Terms and Condition
            </a>
