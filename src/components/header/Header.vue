...
const onHover = (platform) => {
  isPlatformHovered.value = true;
...
<template>
  ...
  >
    ...
    <div class="flex items-center space-x-2">
      <img src="/Open Observe Logo.svg" alt="Logo" class="h-8 w-auto md:h-10" />
    </div>

    <!-- Navigation -->
    <nav
      class="hidden md:flex items-center space-x-6 text-[#BEC0C2] font-inter font-semibold text-sm"
    >
      <a
        href="#"
        class="hover:text-white transition"
        @mouseenter="onHover('platform')"
        @mouseleave="onMouseLeave"
        >Platform</a
      >

      <a href="#" class="hover:text-white transition">Solution</a>
    ...
    <div class="flex items-center space-x-2 md:space-x-4">
      <!-- CustomButton Components -->
      <CustomButton variant="tertiary" class="text-xs sm:text-sm font-semibold">
        LOGIN IN
      </CustomButton>
      <CustomButton
        variant="secondary"
      ...
      <CustomButton variant="primary" class="text-xs sm:text-sm font-semibold">
        GET DEMO
      </CustomButton>
    </div>
    ...
    <div>
      ...
      <div class="w-full flex flex-row gap-2">
        <div class="w-2/3 grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- Dynamically map sections under platform -->
          <div
            v-for="(section, index) in platformData.platform.items"
            :key="index"
          >
      ...
      <!-- Custom buttons inside the hover header -->
      <div class="flex justify-between mt-6">
        <button class="btn">Full Stack Observability Platform</button>
        <button class="btn">View Platform</button>
