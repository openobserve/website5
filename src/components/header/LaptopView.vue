<template>
  <header class="bg-black">
    <div
      class="w-full mx-auto px-4 flex justify-between items-center"
    >
      <Logo />
      <nav>
        <ul class="flex space-x-2 xl:space-x-6 w-full">
          ...
          >
            <a href="#" class="text-white font-semibold text-lg hover:underline"> Platform </a>
          </li>
          <li class="relative py-8" @mouseenter="onSolutionMenuHover" @mouseleave="onSolutionMenuMouseLeave">
            <a href="#" class="text-white font-semibold text-lg"> Solution </a>
          </li>
          <li class="relative py-8">
            <a href="#" class="text-white font-semibold text-lg"> Resources </a>
          </li>
          <li class="relative py-8">
            <a href="#" class="text-white font-semibold text-lg"> Company </a>
          </li>
          <li class="relative py-8">
            <a href="#" class="text-white font-semibold text-lg"> Pricing </a>
          </li>
        </ul>
      </nav>
      <div class="flex items-center space-x-2 xl:space-x-4">
        <CustomButton variant="tertiary"> LOGIN IN </CustomButton>
        <CustomButton variant="secondary"> DOWNLOAD </CustomButton>
        <CustomButton variant="primary"> GET DEMO </CustomButton>
      </div>
    </div>
    <div
      class="absolute top-full flex justify-center translate-x-[22%] w-full container mx-auto"
      @mouseenter="onPlatformMenuHover"
      ...
      <CustomHoverHeader @mouseleave="onPlatformMenuMouseLeave">
        <div>
          ...
          <div class="w-full flex justify-between flex-col md:flex-row gap-2">
            <div
              class="w-full md:w-2/3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6"
            >
    ...
    <div
      class="absolute top-full flex justify-center translate-x-1/4 w-full container mx-auto"
