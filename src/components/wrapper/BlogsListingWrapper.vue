...
const props = defineProps({
  suggestionData: { type: Object, required: true },
  blogsData: { type: Object, required: true },
  currentPage: { type: Number, required: true },
  categoryId: { type: String, required: true }
});

const emit = defineEmits(['updateCategory', 'updatePage']);
...
const selectSuggestion = (suggestion) => {
  ...
  emit('updateCategory', suggestion.id);
